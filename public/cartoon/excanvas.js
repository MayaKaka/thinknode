...
(function () {
  ...
  var G_vmlCanvasManager_ = {
    ...
    initElement: function (el) {
	  ...
	  try {
	  	...
	  	throw Error('Could not create Object HTML!');
	  }
  ...
  contextPrototype.drawImage = function (image, var_args) {
    ...
    // Cartoon Ext
    slImage.opacity = this.globalAlpha;
  };
  ...
  contextPrototype.fillText = function(textToDraw, x, y) {
	...
	var slText = drawShape(this, '<TextBlock Text="%1" Canvas.Left="%2" Canvas.Top="%3" />', [textToDraw, x, y]);
 
  	slText.opacity = this.globalAlpha;
  	slText.foreground = this.fillStyle;
  	slText.fontSize = parseFloat(this.font);
  	slText.textWrapping = 'Wrap';
