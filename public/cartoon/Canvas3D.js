...
var Canvas3D = DisplayObject.extend({
	...
	init: function(props) {
		this._super(props);
		this._context3d = this.elem.getContext('webgl') || this.elem.getContext('experimental-webgl');
		this._initWebGL(this._context3d);
		start(this.elem);
	},
