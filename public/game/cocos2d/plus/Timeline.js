...
var p = Timeline.prototype; // = new ccp.EventDispatcher();
...
// constructor:
	...
	**/
	p.initialize = function(tweens, labels, props) {
		...
		else { ccp.Tween._register(this,true); }
		if (props&&props.position!=null) { this.setPosition(props.position, ccp.Tween.NONE); }
	};
...
// public methods:
	...
	p.addTween = function(tween) {
		...
		if (this._prevPos >= 0) { tween.setPosition(this._prevPos, ccp.Tween.NONE); }
		return tween;
	};
	...
	p.setPaused = function(value) {
		this._paused = !!value;
		ccp.Tween._register(this, !value);
	};
