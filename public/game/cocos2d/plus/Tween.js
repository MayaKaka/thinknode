...
// static interface:
	...
	Tween._register = function(tween, value) {
		...
		if (value) {
			...
			if (!Tween._inited) { // && gameStage) { // createjs.Ticker) { 
				
				// gameStage.schedule(Tween.tick, 1/60);
...
// private methods:
	...
	p._updateTargetProps = function(step, ratio) {
		...
		for (var n in this._initQueueProps) {
			...
			if (!ignore) {
				...
				this._setProp(n, v, this._target); 
				// this._target[n] = v; 
			}
		}
	...
	p._appendQueueProps = function(o) {
		...
		for (var n in o) {
			if (this._initQueueProps[n] === undefined) {
				...
				oldValue = this._getProp(n, this._target);
	 ...
	 * @protected
	 */
	p._setProp = function(n, v, o) {
		switch (n) {
			case 'x': o.setPositionX(v); 
				break;
			case 'y': o.setPositionY(v); 
				break;
			case 'rotationX':
			case 'rx': o.setRotationX(v);
				break;
			case 'rotationY':
			case 'ry': o.setRotationY(v);
				break;
			case 'rotation': 
			case 'ro': o.setRotation(v); 
				break;
			case 'scaleX': 
			case 'sx': o.setScaleX(v); 
				break;
			case 'scaleY':
			case 'sy': o.setScaleY(v); 
				break;
			case 'scale': o.setScale(v); 
				break;
			case 'anchorX': 
			case 'ax': o.setAnchorPoint(cc.p(v, o.getAnchorPoint().y)); 
				break;
			case 'anchorY': 
			case 'ay': o.setAnchorPoint(cc.p(o.getAnchorPoint().x, v)); 
				break;
			case 'opacity': 
			case 'op': o.setOpacity?o.setOpacity(v):null;
				break;
			case 'visible': 
			case 'vi': o.setVisible(v);
				break;
			case 'zOrder': 
			case 'z': o.setLocalZOrder(v);
				break;
			default:
				o[n] = v; break;
		}
	 ...
	 * @protected
	 */
	p._getProp = function(n, o) {
		var v;
		switch (n) {
			case 'x': v = o.getPositionX(); 
				break;
			case 'y': v = o.getPositionY(); 
				break;
			case 'rotationX':
			case 'rx': v = o.getRotationX();
				break;
			case 'rotationY':
			case 'ry': v = o.getRotationY();
				break;
			case 'rotation': 
			case 'ro': v = o.getRotation(); 
				break;
			case 'scaleX': 
			case 'sx': v = o.getScaleX(); 
				break;
			case 'scaleY':
			case 'sy': v = o.getScaleY(); 
				break;
			case 'scale': v = o.getScale(); 
				break;
			case 'anchorX': 
			case 'ax': v = o.getAnchorPoint().x; 
				break;
			case 'anchorY': 
			case 'ay': v = o.getAnchorPoint().y; 
				break;
			case 'opacity': 
			case 'op': v = o.getOpacity?o.getOpacity():255;
				break;
			case 'visible': 
			case 'vi': v = o.isVisible();
				break;
			case 'zOrder': 
			case 'z': v = o.getLocalZOrder();
				break;
			default:
				v = o[n]; break;
		}
