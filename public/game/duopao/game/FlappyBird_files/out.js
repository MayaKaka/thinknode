...
(function() {
    ...
    String.format || (String.format = function() {
        ...
        for (var a = arguments[0] || "", c, i = 1, v = arguments.length; i < v; i++)
            c = RegExp("\\{" + (i - 1) + "\\}", "gm"), a = a.replace(c, arguments[i]);
        return a
    });
    ...
    var j = "linkScreen", p = "12px Arial", s = 240, t = 320, w = [], E = [], A = "", D = 1, ha = !1, x = 1, f = {loadRes: null,pageLoad: null,menu: null,run: null,runFn: function() {
        },rafRun: null,stop: null,over: null,zone: null,active: null,lastDate: Date.now(),timeout: 30,isPause: !1,gameFlow: -1,loadedImageToGameFlow: -1,zoneArgs: null,activeArgs: null,spendTime: 0,loadResTimer: null,playTimer: null}, d = {key: 0,keys: {up: !1,down: !1,left: !1,right: !1,a: !1,
            b: !1,c: !1,menu: !1,quit: !1},lastKey: {up: !1,down: !1,left: !1,right: !1,a: !1,b: !1,c: !1,menu: !1,quit: !1},pressedKey: {up: !1,down: !1,left: !1,right: !1,a: !1,b: !1,c: !1,menu: !1,quit: !1},keyPressCtrl: {up: !0,down: !0,left: !0,right: !0,a: !0,b: !0,c: !0,menu: !0,quit: !0},keyDownGo: !1,keyUpGo: !1,keyPressedGo: !1,keyDownCallBack: null,keyUpCallBack: null,orientationChange: null,touchStart: null,touchEnd: null,touchMove: null,touchCancel: null,clickCallBack: null,mouseDownCallBack: null,mouseUpCallBack: null,mouseMoveCallBack: null,
        focused: !1,pageFocusCallBack: null,pageUnFocusCallBack: null,pageOffX: 0,pageOffY: 0}, u = {}, F = [], S = {}, K = {}, J = 0, q = 0, L = "", X = !1, y = {}, r = {xhrObj: null,pool: [],poolLength: 5,date: null,isTimeout: !1,param: {type: "get",data: null,dataType: "json",url: "",xhr: null,timeout: 5E3,before: function() {
            },success: function() {
            },error: function() {
            },complete: function() {
            }}}, da = [], ea = {up: 38,down: 40,left: 37,right: 39,a: 90,b: 88,c: 67,menu: 49,quit: 50}, z = {menu: 0,run: 1,stop: 2,over: 3,zone: 4,active: 5,loadImage: 6,loadedImage: 7}, fa, l = {getCanvasDom: function() {
            fa || 
            ...
            var v = m.canvas.screen.getWidth(), b = m.canvas.screen.getHeight(), d = parseInt(v - v >> 1), e = b - 5, a = a > c ? c : a, ia = parseInt(100 * (a / c)) + "%";
            ...
            if (0 <= a.indexOf("?")) {
                ...
                for (var c = [], i = 0; i < a.length; i++)
                    0 <= a[i].indexOf("=") && (c = a[i].split("="), da[c[0]] = c[1])
            }
        },audioEnded: function() {
    ...
    R, U, Y = [], ja = 0, Z = 0, V, M, W, N, m = jsGame = link = {init: function(a, c) {
            ...
            if ("object" == typeof c)
                if (void 0 != c.length)
                    ...
                    c)
                        void 0 !== c[i] && (a[i] = null != c[i] && "object" == typeof c[i] ? void 0 != c[i].length ? c[i].slice(0) : c[i] : c[i]);
            return a
        },classes: {},comm: {registerNotify: function(a, c) {
                null != a && a.register(c)
                ...
                for (var e = [], a = (i || 0) - (a || 0), g = (b || 0) - (c || 0), c = Math.sqrt(Math.pow(a, 2) + Math.pow(g, 2)), b = d = d || 5, h = i = 0, f = 180 * (Math.atan2(g, a) / Math.PI), f = 0 <= f ? f : f + 360; b < c + d; )
                    b = b > c ? c : b, a = b * Math.cos(f / 180 * Math.PI), g = b * Math.sin(f / 180 * Math.PI), e.unshift([a - i, g - h]), i = a, h = g, b += d;
                return e
            ...
            setColor: function(a, c, i) {
                ...
                if (j.refreshed)
                    ...
                    null != h && (c = 0 > c ? 0 : c, h = 0 >= h ? 0.1 : h), null != f && (i = 0 > i ? 0 : i, f = 0 >= f ? 0.1 : f), null != b && null != h && (b = 0 >= b ? 0.1 : c + b <= j.width ? b : j.width - c), null != d && null != f && (d = 0 >= d ? 0.1 : i + d <= j.height ? d : j.height - i), j.loaded && (b ? d ? q ? (G = l.getAnchor(e, g, h, f, q), k.drawImage(j, c, i, b, d, G.x, 
                    ...
                    l.setImage(a.id, a.src, a.benchId, a.bench, a.cache), a.inited = !0;
                return this
        ...
        audio: {play: function(a) {
            ...
            mouseDown: function(a) {
                ...
                return m
            }},ui: {},graphics: {HCENTER: 1,VCENTER: 2,LEFT: 4,
            RIGHT: 8,TOP: 16,BOTTOM: 32},trans: {TRANS_NONE: 0,TRANS_ROT90: 5,TRANS_ROT180: 3,TRANS_ROT270: 6,TRANS_MIRROR: 2,TRANS_MIRROR_ROT90: 7,TRANS_MIRROR_ROT180: 1,TRANS_MIRROR_ROT270: 4},request: {init: function() {
    ...
    link.getScript = function(a) {
        if (!$ || I)
            return !1;
        a = m.objExtend({url: "",before: function() {
            },
            success: function() {
            },error: function() {
            },timeout: 5E3,contentType: "text/javascript",destroyed: !0}, a || {});
    ...
    link.action.Role.prototype.action = function() {
        ...
        if (e) {
            ...
            if (0 < this._path.length)
                j = this._path.shift(), h = j[0] || 0, j = j[1] || 0, this._skipMoveDs || this.setSprite(this._moveDs[B(h, j)], !0), this.svx = h, this.svy = j, this.mapOffx += this.svx, this.mapOffy += this.svy;
...
(function(g) {
    ...
    g.init(320, 550).pushImage([{id: "bg1",src: "FlappyBird_files/bg1.jpg"}, {id: "bg2",src: "FlappyBird_files/bg2.jpg"}, {id: "s1",src: "FlappyBird_files/s1.png"}]).asyncImage([{id: "s2",src: "FlappyBird_files/s2.png"}, {id: "n1",src: "FlappyBird_files/number1.png"}, {id: "n2",src: "FlappyBird_files/number2.png"}]);
    C || g.initAudio([{id: "sound1",src: "FlappyBird_files/sound1.mp3",loop: !1,preload: !0}]);
    g.pageLoad(function() {
        var b, e, n, h, j, p, s, t;
        window.scrollTo(0, 1);
        var w, E;
        ...
        _newDate = Date.now();
        var A, D = [];
        A = {Button: g.extend(function(b) {
                this.props = g.objExtend({id: "",value: "",x: 0,y: 0,width: 60,height: 30,img: null,color: "#000",strokeColor: "#FFF",bgColor: "",font: "20px \u5fae\u8f6f\u96c5\u9ed1"}, b || {});
                this.collision(0, 0, 0, 0)
            }, null, {collision: function(b, d, e, f, h) {
        ...
        var B = g.canvas.screen.getDevice(), x = {bird: null,bgType: 0,isGameOver: !1,bgColor: "#000",bgX: 0,bgY: 0,bgImgW: 288,bgImgH: 512,bgWidth: 0,bgHeight: 0,speed: 0,landX: 0,landY: 0,landW: 672,landH: 112,g: "android" == B && !C ? 0.7 : 1.5,jumpSpeed: "android" == B && !C ? -8 : -12,vy: 0,obses: [],obsDate: null,obsTimeout: 1800,obsFrameNum: 57,obsCurrentFrame: 0,obsState: "ready",score: 0,
            scoreObsId: "",obsMapping: {mp1: {id: "s2",sx: 112,sy: 130,width: 52,height: 320},mp2: {id: "s2",sx: 168,sy: 130,width: 52,height: 320},mp3: {id: "s2",sx: 0,sy: 130,width: 52,height: 320},mp4: {id: "s2",sx: 56,sy: 130,width: 52,height: 320}},screenFlush: [],birdSpriteId: 0,bgId: 1,init: function(b, d) {
                this.isGameOver = !1;
                ...
                this.isGameOver || (this.screenFlush = [1, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1, 0], g.audio.pauseAll().playRange("sound1", 5, 6), window.dp_submitScore && dp_submitScore(-1, x.score));
                return this
            },initObses: function() {
                this.obses = [];
                ...
                this.obses.push({id: g.getNewGuid(),
                ...
                switch (this.obsState) {
                    ...
                    case "run":
                        for (var b = this.obses.length - 1, d; d = this.obses[b]; b--)
                            d.x += this.speed, this.bird.collisionInput(d.x, d.y, d.width, d.height, "bR") && this.gameOver(), -52 >= d.x && this.obses.splice(b, 1);
                ...
                for (var b, d = 0, e; e = this.obses[d]; d++)
                    b = e.imgObj, g.canvas.drawImage(b.id, b.sx, b.sy, b.width, b.height, e.x, e.y, b.width, b.height);
                return this
                ...
                [-3, -2, -1, 1, 2, 3], s = d + 500, t = [-200, -100, -70, -40, -20, -10, -5], u = A.appendButton({id: "playBtn",x: f + 40,y: d + 180,width: 112,height: 66,img: {id: "s1",sx: 120,sy: 236,sw: 112,sh: 66}}), F = A.appendButton({id: "rankBtn",x: f + 150,y: d + 180,width: 112,height: 66,img: {id: "s1",sx: 240,sy: 236,sw: 112,sh: 66}}), g.gameFlow.over()));
                return this
            },render: function() {
        ...
        K = function() {
            ...
            A.clearButtons();
            g.gameFlow.run()
        }, J = {values: [],opacity: 0,callBack: null,init: function() {
                this.values = [];
                this.opacity = 0;
                this.callBack = null;
                return this
        ...
        x.init(w >> 1, d + 90);
        A.clearButtons();
        u = A.appendButton({id: "playBtn",x: f + 40,y: d + 180,width: 112,height: 66,img: {id: "s1",sx: 120,sy: 236,sw: 112,sh: 66}});
        F = A.appendButton({id: "rankBtn",x: f + 150,y: d + 180,width: 112,height: 66,img: {id: "s1",sx: 240,sy: 236,sw: 112,sh: 66}});
        g.gameFlow.menu()
    })
})(link);
