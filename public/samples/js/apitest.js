var apitest = {
	...
	paint: {
		init: function(ct, dom, cvs, $fps) {
			...
			cvs.addChild(rect);
			cvs.addChild(circle);
			cvs.addChild(ellipse);
			cvs.addChild(line);
			cvs.addChild(ploygon);
			cvs.addChild(star);
			cvs.addChild(star1);
			cvs.addChild(lines);
	...
	ball: {
		init: function(ct, dom, cvs, $fps) {
			...
			var swpan = function(evt, renderMode) {
				(renderMode ? world_cvs : world).addChild(new ct.Shape({
